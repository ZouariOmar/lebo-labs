# Contributing to lebo-labs

Thank you for your interest in contributing to lebo-labs! Contributions from the community are welcome and appreciated.
...
2. Clone your fork to your local machine:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/lebo-labs.git
   ```
...
Please check the [issues](https://github.com/lebo-labs/issues) tab to see where help is needed.
...
By contributing to lebo-labs, you agree that your contributions will be licensed under the same license as the project.
